...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic:
        ...
        if results_dic[key][3] == 1:
            results_stats_dic['n_dogs_img'] += 1.0         
            # correct dog
            if results_dic[key][4] == 1:
                results_stats_dic['n_correct_dogs'] += 1.0
        # corrent non-dog
        else:
            if results_dic[key][3] == 0 and results_dic[key][4] == 0:
                results_stats_dic["n_correct_notdogs"] += 1.0         
        # correct match
        if results_dic[key][2] == 1:
                results_stats_dic['n_match'] += 1.0
        
        # correct breed
        if results_dic[key][2] == 1 and results_dic[key][3] == 1:
                results_stats_dic['n_correct_breed'] += 1.0       
    ...
    if results_stats_dic['n_images'] > 0:
        ...
        print("hello adding pct_match", results_stats_dic['pct_match'], results_stats_dic['n_match'] / results_stats_dic['n_images'])
    else:
